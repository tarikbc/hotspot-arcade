...
- **Werewolf** — the social deduction classic, with the phones as referee: they deal the
  secret roles (werewolves, one seer, the rest villagers) and run the clock, while the
  arguing happens out loud in the room. Night: the wolves agree on a victim and the seer
  privately checks someone. Day: the body is announced and everyone votes a suspect out,
  role revealed. Repeat until the wolves are gone or they outnumber the village. Needs
  five players; no packs — the roles are code.
