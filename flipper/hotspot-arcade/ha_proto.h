...
// 16..19 are reserved for games in flight on other branches, so this one starts at
// 20; the id renumbers trivially if those land first (it is not persisted).
#define HA_GAME_FRANKENDRAW 20 // exquisite corpse: head/torso/legs by three hands (party)
